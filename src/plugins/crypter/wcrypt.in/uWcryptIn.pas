...
function TWcryptIn.GetName: WideString;
begin
  Result := 'wCrypt.in';
end;

function TWcryptIn.GenerateFolder(MirrorController: IMirrorControl): WideString;
var
...
function TWcryptIn.GetFolderInfo(FolderURL: WideString): TCrypterFolderInfo;
var
  _lkJSONobject: TlkJSONobject;
...
procedure TWcryptIn.GetFolderPicture(FolderURL: WideString; out Result: WideString; Small: Boolean);
begin
