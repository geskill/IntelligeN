...
function TThreadStringList.GetNameValueSeparator: Char;
begin
  LockList;
  try
...
procedure TThreadStringList.SetNameValueSeparator(const Value: Char);
begin
  LockList;
  try
    FStringList.NameValueSeparator := Value;
  finally
    UnlockList;
  end;
end;
...
function TThreadStringList.GetValueFromIndex(Index: Integer): string;
begin
  LockList;
  try
...
procedure TThreadStringList.SetValueFromIndex(Index: Integer; const Value: string);
begin
  LockList;
  try
