...
function TJadedvideoCom.GetAuthor;
begin
  Result := 'Sebastian Klatte';
end;

function TJadedvideoCom.GetAuthorURL;
begin
  Result := 'http://www.intelligen2009.com/';
end;

function TJadedvideoCom.GetDescription;
begin
...
function TJadedvideoCom.InternalGetRetrieveData;
