...
type
  TComponentID = (cReleaseName, cReleaseDate, cTags, cTitle, cArtist, cPicture, cTrailer, cSample, cNotes, cPassword, cAudioBitrate, cAudioBitrateType, cAudioEncoder,
    cAudioSamplingRate, cAudioStream, cGenre, cLanguage, cRuntime, cVideoCodec, cVideoStream, cVideoSystem, cNFO, cDescription);
...
const
  TStringComponentID: array [0 .. 22] of string = ('IReleaseName', 'IReleaseDate', 'ITags', 'ITitle', 'IArtist', 'IPicture', 'ITrailer', 'ISample', 'INotes',
    'IPassword', 'IAudioBitrate', 'IAudioBitrateType', 'IAudioEncoder', 'IAudioSamplingRate', 'IAudioStream', 'IGenre', 'ILanguage', 'IRuntime',
    'IVideoCodec', 'IVideoStream', 'IVideoSystem', 'INFO', 'IDescription');
{$IFDEF MAINAPP}
